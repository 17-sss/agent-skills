...
- `.claude-plugin/marketplace.json` is compatibility metadata used by the `skills` CLI to group the four Codex-dependent workflows under `Codex` and the eight cross-agent skills under `Other`
