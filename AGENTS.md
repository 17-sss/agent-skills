...
- Keep the three Codex-dependent workflows under `Codex`; the ten cross-agent skills are grouped by purpose, with `godot-dev-loop` under `Experimental` to make its maturity visible
