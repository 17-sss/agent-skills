...
- Workspace-wide shared file: `_memory/HANDOFF.md`
- Workstream shared file: `_memory/workstreams/<name>/HANDOFF.md`
...
- Use `_memory/workstreams/<name>/...` when one workspace hosts multiple independent repo combinations
